<?php
    ...
    if ($dados['table'] == 'clientes') {
        ...
        $sql = "UPDATE $dados[table] set nome = '$dados[nome]',descricao = '$dados[descricao]',preco = '$dados[preco]',quantidade = '$dados[quantidade]',vendedor_id = '$dados[vendedor_id]' where id = $dados[id]";
    }
